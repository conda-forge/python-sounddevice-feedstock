...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-sounddevice-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-sounddevice-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add python-sounddevice
# for installing globally
pixi global install python-sounddevice
```
...
It is possible to list all of the versions of `python-sounddevice` available on your platform:
...
```
pixi search python-sounddevice --channel conda-forge
```
